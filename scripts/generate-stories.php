 ...
 * - A CSF (Component Story Format) file for Storybook
...
try {
    print_r("Sorry, the story generator still needs to be updated since the migration to CSF format.\n");
    print_r("Please manually create your story file for now by referring to the existing ones as a guide.\n");
