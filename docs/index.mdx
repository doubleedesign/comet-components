...
| BaguetteBox | Vanilla JS lightbox plugin        | Used to make the gallery block a lightbox if set to link to media files.                                                                                                                           |
...
| NPM        | JavaScript package manager | Used to manage JavaScript dependencies and build scripts. Primarily for local development and tooling (e.g. Storybook, Rollup). `node_modules` for any package should not be uploaded to the server.                                                                             |
