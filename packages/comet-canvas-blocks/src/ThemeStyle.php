...
class ThemeStyle {
    ...
    private function get_css_variables_from_theme_json(): string {
    ...
    public function add_css_variables_to_head(): void {
        echo '<style>:root {' . $this->get_css_variables_from_theme_json() . '}</style>';
    }

    public function add_css_variables_to_block_editor(): void {
        // Attaching this to comet-global-styles ensures it overrides Comet's global.css
        wp_add_inline_style('comet-global-styles', ":root { {$this->get_css_variables_from_theme_json()} }");
    }
    ...
    public function enqueue_theme_stylesheets(): void {
        ...
        if (file_exists($parent)) {
            ...
            wp_enqueue_style('comet-canvas-blocks', $parent, $deps, '0.3.0'); // TODO: Get this dynamically
        }
    ...
    public function enqueue_editor_specific_css(): void {
