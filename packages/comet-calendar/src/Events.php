...
class Events {
     ...
     * @return void
     */
    public function save_acf_fields_to_plugin($group): void {
    ...
    public function enqueue_admin_js(): void {
        ...
        wp_enqueue_script('comet-calendar-admin', $js_path, array('jquery-core'), COMET_CALENDAR_VERSION, true);
    }
     ...
     * @return void
     */
    public function remove_yoast_metabox(): void {
