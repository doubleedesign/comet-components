...
class SiteHealth {
    ...
    public static function required_plugins_status(): array {
        $successes = array();
        $errors = array();
        $warnings = array();
        $theme = wp_get_theme();
        ...
        if ($theme->get('TextDomain') === 'comet' || $parent_theme->get('TextDomain') === 'comet') {
            $required = [
                ...
                'comet-plugin-acf/comet.php'              => 'Comet Components for ACF Flexible Content',
            ];
            $recommended = [
    ...
    public function required_plugins_site_health($tests): array {
    ...
    public function site_health_plugin_check_required(): array {
    ...
    public function site_health_plugin_check_recommended(): array {
        $status = SiteHealth::required_plugins_status();
    ...
    public function site_health_plugin_check_correct(): array {
        $status = SiteHealth::required_plugins_status();
